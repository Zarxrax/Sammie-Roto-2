...
from object_removal.minimax.downloads import DOWNLOADS



class MinimaxRemovalManager(RemovalManager):
    def run(self, points, parent_window=None):
        return self.run_object_removal_minimax(points, parent_window)
    ...
    def load_minimax_model(self, parent_window=None):
        ...
        from object_removal.minimax.vendor.pipeline_minimax_remover import Minimax_Remover_Pipeline
        from object_removal.minimax.vendor.transformer_minimax_remover import Transformer3DModel
