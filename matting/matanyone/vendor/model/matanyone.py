...
from matting.matanyone.vendor.model.big_modules import PixelEncoder, UncertPred, KeyProjection, MaskEncoder, PixelFeatureFuser, MaskDecoder
from matting.matanyone.vendor.model.aux_modules import AuxComputer
from matting.matanyone.vendor.model.utils.memory_utils import get_affinity, readout
from matting.matanyone.vendor.model.transformer.object_transformer import QueryTransformer
from matting.matanyone.vendor.model.transformer.object_summarizer import ObjectSummarizer
from matting.matanyone.vendor.utils.tensor_utils import aggregate

log = logging.getLogger()
class MatAnyone(nn.Module):

    def __init__(self, cfg: MatAnyoneConfig, *, single_object=False):
        super().__init__()
        self.cfg = cfg
        model_cfg = cfg.model
