...
from segmentation.sam2.vendor.modeling.position_encoding import apply_rotary_enc, compute_axial_cis
from segmentation.sam2.vendor.modeling.sam2_utils import MLP
...
class Attention(nn.Module):
    ...
    def forward(self, q: Tensor, k: Tensor, v: Tensor) -> Tensor:
        ...
        if q.dtype != k.dtype: # these if statements added for mps support
