...
from segmentation.sam2.vendor.modeling.sam2_base import NO_OBJ_SCORE, SAM2Base
from segmentation.sam2.vendor.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames
...
class SAM2VideoPredictor(SAM2Base):
    ...
    def from_pretrained(cls, model_id: str, **kwargs) -> "SAM2VideoPredictor":
        ...
        """
        from segmentation.sam2.vendor.build_sam import build_sam2_video_predictor_hf
    ...
    def _get_image_feature(self, inference_state, frame_idx, batch_size):
        ...
        if backbone_out is None:
            ...
            device = inference_state["device"]
            #image = inference_state["images"][frame_idx].to(device).float().unsqueeze(0) #changed to float 32 to support mps
            image = inference_state["images"][frame_idx].to(device, dtype=torch.float32).unsqueeze(0)
